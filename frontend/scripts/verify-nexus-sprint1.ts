...
assert.equal(roleHasPermission("CLINIXAI_SUPER_ADMIN", PERMISSIONS.ENTITLEMENT_MANAGE), true);
assert.equal(roleHasPermission("CLIENT_ADMIN", PERMISSIONS.ENTITLEMENT_MANAGE), false);
