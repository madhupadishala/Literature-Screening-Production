...
export const REQUIRED_DATABASE_MIGRATIONS: readonly RequiredMigration[] = [
  ...
  },
  {
    ...
    filename: "022_nexus_module_entitlements.sql",
    required: true,
  },
  {
    id: "023",
    name: "Nexus Common Safety Backbone",
    filename: "023_nexus_common_safety_backbone.sql",
    required: true,
  },
  {
    id: "024",
    name: "Nexus Intake Sources",
    filename: "024_nexus_intake_sources.sql",
    required: true,
  },
  {
    id: "025",
    name: "Nexus Intake Review and Extraction",
    filename: "025_nexus_intake_review_extraction.sql",
    required: true,
  },
  {
    id: "026",
    name: "Nexus ICSR Validity and Triage",
    filename: "026_nexus_icsr_validity_triage.sql",
    required: true,
  },
  {
    id: "027",
    name: "Nexus Duplicate and Follow-Up Review",
    filename: "027_nexus_duplicate_followup_review.sql",
    required: true,
  },
  {
    id: "028",
    name: "Nexus Intake Disposition",
    filename: "028_nexus_intake_disposition.sql",
    required: true,
  },
  {
    id: "029",
    name: "Nexus L2A Case Processing",
    filename: "029_nexus_l2a_case_processing.sql",
    required: true,
  },
  {
    id: "030",
    name: "Nexus Case Review and Finalization",
    filename: "030_nexus_case_review_finalization.sql",
    required: true,
  },
  {
    id: "031",
